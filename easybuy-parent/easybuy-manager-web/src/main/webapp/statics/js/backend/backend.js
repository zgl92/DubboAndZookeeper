...
function toAddProductCategory() {
    $.ajax({
        url: contextPath + "/toAddProductCategory",
        method: "post",
        data: null,
        dataType:"html",
...
function queryProductCategoryList(obj, selectId) {
    ...
    $.ajax({
        url: contextPath + "/queryProductCategoryList",
        method: "post",
...
function toUpdateProductCategoryList(obj) {
    var id = $(obj).val();
    $.ajax({
        url: contextPath + "/toUpdateProductCategory",
        method: "post",
        data: {id: id},
        success: function (result) {
            $("#addProductCategory").html(result);
        }
    });
}
//修改
...
function modifyProductCategory() {
    ...
    var type = $("#type").val();
    $.ajax({
        url: contextPath + "/modifyProductCategory",
        method: "post",
        data: {
            id: id,
            name: name,
...
function selectProductCategoryLevel(obj) {
	queryProductCategoryList(document.getElementById("valueZero"),"productCategoryLevel1");
    var level = $(obj).val();
    if (level == 1) {
